...
function com_port_edit_Callback(hObject, eventdata, handles)
% hObject    handle to com_port_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of com_port_edit as text
%        str2double(get(hObject,'String')) returns contents of com_port_edit as a double


% --- Executes during object creation, after setting all properties.
function com_port_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to com_port_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
